...
class SasList extends Component {
    static propTypes = {
    ...
    componentDidMount() {
        ...
        this.props.list('/products?category=personalized');
    }
            ...
            <div>
                ...
                {this.props.retrieved &&
                    <div className="text-center mt-3">
                        ...
                        {this.props.retrieved['hydra:totalItems']} Produits
                        </span>
                    </div>
                }
                <div id="selectioned" className="container py-3 mt-0 mb-2">
                    <div className="row">
                        <div className="selectionned-products sas-list d-flex flex-wrap justify-content-center">
                            {this.props.retrieved &&
                            this.props.retrieved['hydra:member'].map((item, index) => (
                                <>
                                {index === 4 &&
                                    <>
                                    <div className="app-advertising my-5 d-flex flex-column">

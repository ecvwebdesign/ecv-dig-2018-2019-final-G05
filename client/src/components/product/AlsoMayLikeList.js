...
class AlsoMayLikeList extends Component {
    static propTypes = {
    ...
    newProduct = (product) => {
        this.props.retrieve(decodeURIComponent(product['@id']));
    }
                ...
                <div id="selectioned" className="container py-3 my-2">
                    <div className="row">
                        ...
                        <div className="selectionned-products d-flex">
                            ...
                            this.props.retrieved['hydra:member'].sort(() => Math.random() - 0.5).map(item => (
                                <div className="product" key={item['@id']}>
                                    <div className="d-flex flex-column">
                                        <div className="img-wrapper">
                                            <Link to={`/products/show/${encodeURIComponent(item['@id'])}`} onClick={() => this.newProduct(item)}>
